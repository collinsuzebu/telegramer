...
def test_delete_media_host():
    ...
    a3 = delete_media_host(
        'Leil Lowndes - Trick 26 - How to Be a "You-Firstie" to Gain Their Respect and Affection'
    )
    assert (
        a3
        == "Leil Lowndes - Trick 26 - How to Be a 'You-Firstie' to Gain Their Respect and Affection"
    ...
    a7 = delete_media_host(
        "Artist - Song Title (feat. Artist) | music.com [Prod. by producer] || music.net"
    )
    ...
    a9 = delete_media_host(
        "Follow music.com.ng CEO on IG @XXX111XXX - #music.ng - Best of Artist Dj Name"
    )
    ...
    a12 = delete_media_host(
        "Leil Lowndes - Trick 32 - How to Sound Like You Know All About Their Job or Hobby"
    )
    assert (
        a12
        == "Leil Lowndes - Trick 32 - How to Sound Like You Know All About Their Job or Hobby"
